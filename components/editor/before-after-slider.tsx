  ...
  return (
    ...
    >
      ...
      <img
        ...
        draggable={false}
      />
      <span className="absolute left-3 top-3 rounded-full bg-ink/80 px-2.5 py-1 text-[11px] font-medium text-white">Original</span>
      <span className="absolute right-3 top-3 rounded-full bg-clay px-2.5 py-1 text-[11px] font-medium text-white">Diseño</span>
