...
const SEED: Seed[] = [
  ...
  // ---------- INSTALLATION SUPPLIES (Assembly accessory components) ----------
  { id: "sup-underlayment", name: "Flooring Underlayment 3mm", brand: "QuietWalk", sku: "SUP-UND-3MM", category: "installation_supply", subcategory: "Underlayment", unit: "sq_ft", color: "—", style: "—", description: "3mm foam underlayment with vapor barrier for floating floors.", swatch: "linear-gradient(120deg,#dcdcd6,#c7c7bf)", laborCategory: "general_labor", wastePercent: 5, basePrice: 0.45 },
  { id: "sup-transition-strip", name: "Floor Transition Strip", brand: "Zamma", sku: "SUP-TRN-01", category: "installation_supply", subcategory: "Transition", unit: "linear_ft", color: "Matches flooring", style: "—", description: "T-molding / reducer transition strip between rooms and flooring types.", swatch: "linear-gradient(120deg,#c9ac83,#a9875e)", laborCategory: "general_labor", wastePercent: 5, basePrice: 3.5 },
  { id: "sup-thinset", name: "Thinset Mortar", brand: "Mapei", sku: "SUP-THN-01", category: "installation_supply", subcategory: "Adhesive", unit: "sq_ft", color: "Gray", style: "—", description: "Modified thinset mortar, coverage-equivalent per sq ft of tile set.", swatch: "linear-gradient(120deg,#b7b3ab,#928e86)", laborCategory: "general_labor", wastePercent: 5, basePrice: 0.6 },
  { id: "sup-grout", name: "Tile Grout", brand: "Mapei", sku: "SUP-GRT-01", category: "installation_supply", subcategory: "Grout", unit: "sq_ft", color: "Sanded", style: "—", description: "Sanded grout, coverage-equivalent per sq ft of tile.", swatch: "linear-gradient(120deg,#d7d2c8,#b9b3a6)", laborCategory: "general_labor", wastePercent: 5, basePrice: 0.35 },
  { id: "sup-adhesive", name: "Flooring Adhesive", brand: "Henry", sku: "SUP-ADH-01", category: "installation_supply", subcategory: "Adhesive", unit: "sq_ft", color: "—", style: "—", description: "Multi-purpose flooring adhesive, coverage-equivalent per sq ft.", swatch: "linear-gradient(120deg,#e0d9c8,#c2b696)", laborCategory: "general_labor", wastePercent: 5, basePrice: 0.55 },
];
